    ...
    */
    public function html()
    {
	    ...
	    <div class="text-center">
	        ...
	        <textarea rows="5" class="form-control" <?php echo $maxlength?> name="<?php echo $this->id?>" id="<?php echo $this->id?>"><?php if(isset($this->values["input"])) echo $this->values["input"];?></textarea>
